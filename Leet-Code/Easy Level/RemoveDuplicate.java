...
Company: Zoho, Morgan Stanley, Microsoft, Samsung, Google, Wipro, Xome
Platform: Leetcode - 26, GFG
Fraz’s and Striver’s DSE sheet
Description :
...
class Demo{
	public static void main(String args[]){
		...
		int arr[]=new int[]{0,0,1,1,1,2,2,2,3,3,4};
