...
Company: Google, Amazon, Uber, LinkedIn, Adobe, Oracle

Platform: leetcode-2022
Description:
...
Output: [[1,2],[3,4]]
Explanation: The constructed 2D array should contain 2 rows and 2
columns.
...
Output: [[1,2,3]]
Explanation: The constructed 2D array should contain 1 row and 3
columns.
...
class ConvertArray{
	...
	static int[][] convertArray(int arr[],int m,int n){
